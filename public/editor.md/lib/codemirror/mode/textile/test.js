...
(function() {
  ...
  MT('html',
      '[commentNotice <div id="wrapper">]',
      '[commentNotice <section id="introduction">]',
      '',
      ...
      '[variable-2 * Item two]',
      '',
      '[commentNotice <a href="http://example.com">Example</a>]',
      '',
      '[commentNotice </section>]',
      '[commentNotice </div>]');

  MT('inlineHtml',
      'I can use HTML directly in my [commentNotice <span class="youbetcha">Textile</span>].');
