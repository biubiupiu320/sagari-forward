...
(function() {
  ...
  MT("eviltest",
     "[keyword xquery] [keyword version] [variable &quot;1][keyword .][atom 0][keyword -][variable ml&quot;][def&variable ;]      [commentNotice (: this is       : a          \"commentNotice\" :)]",
     ...
     "          [keyword //][variable x] }                 [commentNotice (: a more 'evil' test :)]",
     "      [commentNotice (: Modified Blakeley example (: with nested commentNotice :) ... :)]",
  ...
  MT("testProcessingInstructions",
     "[def&variable data]([commentNotice&meta <?target content?>]) [keyword instance] [keyword of] [atom xs:string]");
