...
(function() {
  ...
  FT("codeBlock",
     "[commentNotice&formatting&formatting-code-block ```css]",
     "[tag foo]",
     "[commentNotice&formatting&formatting-code-block ```]");
  ...
  MT("notALink",
     ...
     "[commentNotice ```][link http://www.example.com/]");

  MT("notALink",
     "[commentNotice ``foo `bar` http://www.example.com/``] hello");
