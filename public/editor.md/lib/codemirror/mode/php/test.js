...
(function() {
  ...
  MT('variable_interpolation_escaping',
     '[meta <?php] [commentNotice /* Escaping */]',
  ...
  MT('variable_interpolation_complex_syntax_2',
     '[meta <?php] [commentNotice /* Monsters */]',
     '[keyword echo] [string "][variable-2 $]{[variable aaa][commentNotice /*}?>} $aaa<?php } */]}[string ->aaa.aaa"];',
     '[keyword echo] [string "][variable-2 $]{[variable aaa][commentNotice /*}?>*/][[','  [string "aaa][variable-2 $aaa][string {}][variable-2 $]{[variable aaa]}[string "]',']]}[string ->aaa.aaa"];',
     '[keyword echo] [string "][variable-2 $]{[variable aaa][commentNotice /*} } $aaa } */]}[string ->aaa.aaa"];');
  ...
  var m1 = build_recursive_monsters(
    ...
    '[commentNotice /* }?>} */] [string "aaa][variable-2 $aaa][string .aaa"]',
    10
  );

  MT('variable_interpolation_complex_syntax_3_1',
     '[meta <?php] [commentNotice /* Recursive monsters */]',
     '[keyword echo] ' + m1[4] + ';',
     '[keyword echo] ' + m1[7] + ';',
     '[keyword echo] ' + m1[8] + ';',
     '[keyword echo] ' + m1[5] + ';',
  ...
  var m2 = build_recursive_monsters(
    ...
    '[commentNotice /* }?>{{ */] [string "a?>}{{aa][variable-2 $aaa][string .a}a?>a"]',
    5
  );

  MT('variable_interpolation_complex_syntax_3_2',
     '[meta <?php] [commentNotice /* Recursive monsters 2 */]',
     '[keyword echo] ' + m2[0] + ';',
     '[keyword echo] ' + m2[1] + ';',
     '[keyword echo] ' + m2[5] + ';',
     '[keyword echo] ' + m2[4] + ';',
  ...
  MT("variable_interpolation_heredoc",
     ...
     "[string here]; [commentNotice // normal]");
})();
