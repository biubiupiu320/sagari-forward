...
(function() {
  ...
  FT("formatting_codeBackticks",
     "[commentNotice&formatting&formatting-code `][commentNotice foo][commentNotice&formatting&formatting-code `]");

  FT("formatting_doubleBackticks",
     "[commentNotice&formatting&formatting-code ``][commentNotice foo ` bar][commentNotice&formatting&formatting-code ``]");
  ...
  MT("consecutiveBackticks",
     "[commentNotice `foo```bar`] hello [commentNotice `world`]");

  // Unclosed with several different groups of backticks
  MT("unclosedBackticks",
     "[commentNotice ``foo ``` bar` hello]");

  // Closed with several different groups of backticks
  MT("closedBackticks",
     "[commentNotice ``foo ``` bar` hello``] world");
  ...
  MT("listAsteriskFormatting",
     ...
     "[variable-2 * ][variable-2&commentNotice `foo`][variable-2  bar]");
  ...
  MT("listNumberFormatting",
     ...
     "[variable-2 4. ][variable-2&commentNotice `foo`][variable-2  bar]");
